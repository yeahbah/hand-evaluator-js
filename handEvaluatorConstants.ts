...
export const constants = Object.freeze({
    NUMBER_OF_CARDS: BigInt(52),
    NUMBER_OF_CARDS_WITH_JOKER: BigInt(53),
    HANDTYPE_SHIFT: BigInt(24),
    TOP_CARD_SHIFT: BigInt(16),
    TOP_CARD_MASK: BigInt(0x000F0000),
    SECOND_CARD_SHIFT: BigInt(12),
    SECOND_CARD_MASK: BigInt(0X0000F000),
    THIRD_CARD_SHIFT: BigInt(8),
    FOURTH_CARD_SHIFT: BigInt(4),
    FIFTH_CARD_SHIFT: BigInt(0),
    ZERO: BigInt(0),
    ONE: BigInt(1),
    FIFTH_CARD_MASK: BigInt(0x0000000F),
    CARD_WIDTH: BigInt(4),
    CARD_MASK: BigInt(0x0F),
    ...
    HANDTYPE_VALUE_STRAIGHTFLUSH: BigInt(HandTypes.StraightFlush) << BigInt(24),
    HANDTYPE_VALUE_STRAIGHT: BigInt(HandTypes.Straight) << BigInt(24),
    HANDTYPE_VALUE_FLUSH: BigInt(HandTypes.Flush) << BigInt(24),
    HANDTYPE_VALUE_FULLHOUSE: BigInt(HandTypes.FullHouse) << BigInt(24),
    HANDTYPE_VALUE_FOUR_OF_A_KIND: BigInt(HandTypes.FourOfAKind) << BigInt(24),
    HANDTYPE_VALUE_TRIPS: BigInt(HandTypes.Trips) << BigInt(24),
    HANDTYPE_VALUE_TWOPAIR: BigInt(HandTypes.TwoPair) << BigInt(24),
    HANDTYPE_VALUE_PAIR: BigInt(HandTypes.Pair) << BigInt(24),
    HANDTYPE_VALUE_HIGHCARD: BigInt(HandTypes.Pair) << BigInt(24),
    CARDS_MASK_TABLE_SIZE: 52,
    RANK_TABLE: [
